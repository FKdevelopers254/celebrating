...
class _NotificationsState extends State<Notifications> with SingleTickerProviderStateMixin {
  ...
  Widget _buildTabBar() {
    return TabBar(
      ...
      tabs: const [
        Tab(child: Text('Alkato', style: TextStyle(fontFamily: 'Montserrat', fontSize: 15.0))),
        Tab(child: Text('Posts', style: TextStyle(fontFamily: 'Montserrat', fontSize: 15.0))),
        Tab(child: Text('Hashtag', style: TextStyle(fontFamily: 'Montserrat', fontSize: 15.0))),
      ],
    );
  }
  ...
  Widget _buildNotificationItem({required String name, required String message, required String time, required String image}) {
    return Padding(
      padding: const EdgeInsets.all(8.0),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
          ...
          Row(
            children: [
              ...
              Column(
                ...
                children: [
                  Text(name, style: GoogleFonts.andika(fontSize: 17, fontWeight: FontWeight.bold)),
